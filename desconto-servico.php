...
<form name="os" action="processa-os.php?acao=descontoservico" method="post">
        ...
        <td>
            ...
            ?>        
                ...
                <div class="form-row">
                    ...
                    <input title="VALOR DO SERVICO" name="valor" id="valor" value="<?php echo $rowItem->VAL_VALOR_SERVICO_OS ?>"  class="form-control" readonly /> </div> 

                    <div class="form-group col-md-2 col-sm-6"><label>Desconto</label>
                    <input title="DESCONTO DO SERVICO" name="desconto" id="desconto" value="<?php echo $rowItem->VAL_DESCONTO_SERVICO_OS ?>" class="form-control" onblur="calculaDesconto()" /> </div>
                    
                    <div class="form-group col-md-2 col-sm-6"><label>Total</label>
                    <input title="VALOR FINAL DO SERVICO" name="total" id="total" value="<?php echo $rowItem->VAL_VALOR_FINAL_SERVICO_OS ?>" class="form-control" readonly /> </div> 
