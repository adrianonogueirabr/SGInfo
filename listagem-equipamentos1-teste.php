...
<?php 
	...
	if($criterio == "C"){
		$res = $con->prepare("SELECT * FROM TBL_EQUIPAMENTO_EQUIP WHERE TBL_CLIENTE_CLI_NUM_ID_CLI = ?");
    ...
    if($res->rowCount()<=0){
		...
		$res = $con->prepare("SELECT * FROM TBL_EQUIPAMENTO_EQUIP WHERE TXT_SERIAL_EQUIP = ?");
		$res->bindParam(1,$valor);
    $res->execute();
    if($res->rowCount()<=0){
    echo "<META HTTP-EQUIV=REFRESH CONTENT='0; URL=consulta-equipamentos.php'><script type=\"text/javascript\">alert(\"Equipamento nao encontrado\");</script>";  
  ...
  <table width="100%" border="0" cellpadding="0">
    <tr>
      <td width="100%">
        ...
        <?php if ($criterio =="C"){ ?>
       	<legend><h3><a href="listagem-clientes1.php?valor=<?php echo $valor ?>&criterio=I"><img src="imagens/voltar.png" width="30" height="30" alt="voltar" title="Clique para voltar" /></a>
		...
		<?php }else{ ?>
			<legend><h3><a href="consulta-equipamentos.php"><img src="imagens/voltar.png" width="30" height="30" alt="voltar" title="Clique para voltar" /></a>	Listagem de Equipamentos</h3></legend>		
		<?php } ?>
      </td>
    </tr>
    <tr>
      <td>
        <table width="100%" class="table-hover  table-bordered table">
          <tr   class="p-3 mb-2 bg-info text-white">
            <th scope="col">ID</th>
            <th scope="col">ATIVO</th>
            <th scope="col">TIPO</th>
            <th colspan="1" scope="col">MARCA/MODELO/SERIAL</th>
          ...
          <tr>
            ...
            <img src="imagens/alterar.png" width="30" height="30" title="Clique para Alterar" /> </a>
            
            <a href="detalhes-equipamentos.php?id=<?php echo $row->NUM_ID_EQUIP;?>">
            <img src="imagens/lupa.jpg" width="30" height="30" title="Clique para Detalhes" /> </a>
            ...
            <img src="imagens/os.png" width="30" height="30" title="Clique para Cadastrar OS" /> </a>
            </td>
          </tr>
          <?php } ?>
        </table>
